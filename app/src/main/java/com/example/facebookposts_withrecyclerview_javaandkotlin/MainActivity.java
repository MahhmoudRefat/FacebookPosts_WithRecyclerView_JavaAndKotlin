...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // كان عندى ايرور انى خليت الليست تتحط بعد ماشغلت الادابتر
        ...
        postList.add(new PostData("Moahmed Refaat",6,"Buckle up , because change is coming to WordPress","http://unblast.com/color-schemes",R.drawable.post_photo,6,5));
        ...
        ;
        postList.add(new PostData("hussin ahmed",20,"When you build the application R.java contains all the memory address and it happens that those address are invalid for next run","http://unblast.com/color-schemes",R.drawable.post_photo,70,9));
        postList.add(new PostData("yoyo Refaat",20,"When you build the application R.java contains all the memory address and it happens that those address are invalid for next run","http://unblast.com/color-schemes",R.drawable.post_photo,70,9));
